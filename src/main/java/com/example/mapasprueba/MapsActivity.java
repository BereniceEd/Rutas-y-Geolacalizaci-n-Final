...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(origen).title("Mi cashita"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(origen));
        mMap.addMarker(new MarkerOptions().position(destino).title("Mi Escuelita"));
    ...
    private String obtenerDireccionesURL(LatLng origin,LatLng dest){
      ...
      //  String sensor = "sensor=false";
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/"+output+"?"
                +parameters+"&key=AIzaSyC69im735dRrG4LtHyxduqr6bifbDSPOBY";
        Log.e("laurl", url);
